...
export default function MethodologyPage() {
  ...
  return <PageShell><main id="main" className="inner-page methodology-page"><header className="page-lead grid-bg"><h1>Methodology</h1><p>Version 0.2 definitions, inclusion rules, source hierarchy, deployment stages, and technology taxonomy.</p></header>
    ...
    <section className="section limitations"><h2>Current limits</h2><p>This release tracks a larger sourced sample, not a complete census. The full NRC pre-application roster, global projects, complete financing histories, the full buyer landscape, supply-chain facilities, and historical stage changes remain incomplete. No headline count is a national total unless it explicitly says so.</p></section>
  </main></PageShell>;
}
