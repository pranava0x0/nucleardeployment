...
export const proofEvents: ProofEvent[] = [
  ...
  { companySlug: "oklo", date: "2026-08-06", kind: "Criticality", label: "Groves isotope test reactor reached first criticality at Lockhart, Texas, the first Reactor Pilot Program reactor to do so on private land and a greenfield site, under a year from groundbreaking", powerNote: "Low-power test reactor. Oklo states it does not generate electricity for the grid. Contributes 0 MWe.", source: "https://oklo.com/newsroom/news-details/2026/Oklos-Groves-Reactor-Achieves-First-Criticality-in-Under-a-Year/default.aspx", verification: "Company-reported" },
