...
export const capacityClaims: CapacityClaim[] = [
  ...
  },
  {
    ...
    band: "construction",
    mwe: 20,
    label: "Hermes 2, Oak Ridge · two 35 MWt reactors on one power system, 20 MWe combined; Kairos separately frames the plant as supplying up to 50 MW to the TVA grid",
    binding: true,
    date: "2026-04",
